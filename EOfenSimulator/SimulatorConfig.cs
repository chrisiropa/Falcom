...
{
   private const string Partner = "EOFEN";
   private const string ZuordnungTableName = "dbo.FALCOM_EOFEN_SIM_EventZuordnung";
   ...
   public static SimulatorConfiguration Load()
   {
      ...
      return new SimulatorConfiguration(
         ...
         LoadParameterValue(builder.ConnectionString, "EOfenOpcServer", LoadParameterValue(builder.ConnectionString, "OpcServer", "opc.tcp://localhost:4840")),
   ...
   {
      if (settings.TryGetProperty("EOfenSimulationLogfilePath", out JsonElement configuredPath))
      {
      ...
      return @"C:\Projekte\LOGS\FALCOM\EOfen_Simulation\EOfen_Simulation.log";
   }

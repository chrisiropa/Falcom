...
# Beispielaufruf
# cu_values = [0.084, 0.026, 0.014, 0.69, 0.037, 0.015, 0.016, 0.017, 0.5, 0.081, 0.017, 0.014, 0.015, 0.054, 0.5, 0.077]
# mn_values = [1.05, 0.431, 0.623, 1.633, 0.394, 0.18, 0.282, 0.5, 1.659, 0.157, 0.147, 0.217, 0.14, 0.407, 1.649, 0.22]
# ziel_cu = 0.77
# ziel_mn = 0.78
...
if __name__ == "__main__":
    ...
    # steel_mixer()
    x_opt = steel_mixer(cu_values, mn_values, ziel_cu, ziel_mn, obergrenze_cu, obergrenze_mn)
...
if x_opt is not None:
    ...
    print(f"\nErrechneter Kupferanteil: {berechnet_cu:.4f}".replace('.', ','))
    print(f"Errechneter Mangananteil: {berechnet_mn:.4f}".replace('.', ','))
